...
function set_unko_info(_param_rosen) {
	...
	if (_param_rosen == "01" || _param_rosen == "02" || _param_rosen == "03") {
		// 札幌近郊
		let fileName = lang === "ja" ? "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_01.json?" : "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_01_" + lang + ".json?";
		...
		// 道央エリア
		let fileName = lang === "ja" ? "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_02.json?" : "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_02_" + lang + ".json?";
		$.getJSON(fileName + now, function (topData) {
		...
		// 道南エリア
		let fileName = lang === "ja" ? "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_03.json?" : "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_03_" + lang + ".json?";
		$.getJSON(fileName + now, function (topData) {
		...
		// 道北エリア
		let fileName = lang === "ja" ? "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_04.json?" : "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_04_" + lang + ".json?";
		$.getJSON(fileName + now, function (topData) {
		...
		// 道東エリア
		let fileName = lang === "ja" ? "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_05.json?" : "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/area/area_05_" + lang + ".json?";
		$.getJSON(fileName + now, function (topData) {
		...
		// 北海道新幹線
		let fileName = lang === "ja" ? "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/senku/senku_24.json?" : "http://34.46.208.100:8080/proxy?url=https://www3.jrhokkaido.co.jp/webunkou/json/senku/senku_24_" + lang + ".json?";
		$.getJSON(fileName + now, function (topData) {
